...
export function LayerSelector({
  ...
  const PRESETS = [
    ...
    {
      name: "GeoPamplona Carriles Bici (WMS)",
      type: "wms" as const,
      url: "https://sig.pamplona.es/ogc/wms",
      isBase: false,
      wmsLayers: "URBA_Lin_RedCiclista",
      attribution: "© Ayuntamiento de Pamplona",
    },
    {
